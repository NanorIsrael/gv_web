      ...
      {aside && (
        <aside className={'aside p-4 '}>
          ...
          <section className="p-2">
            <h4>Profile</h4>
            <p>
              Highly organised and dedicated full stack web applications
              software engineer with record of delivering excellent customer
              experience for high profile organisations.
            </p>
          </section>
          <section className="p-2">
            <h4>Skills</h4>
